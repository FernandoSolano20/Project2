            ...
            get
            {
                ...
                foreach (var text in inputColumnDataNames)
                {
                    inputs += $"<div class='md-form'>" +
                                 $"<input type = \"{inputTypes[position]}\" class=\"form-control {inputClasses[position]}\" id=\"{inputIds[position]}\" placeholder=\"{inputPlaceHolders[position]} \" ColumnDataName=\"{inputColumnDataNames[position]}\">" +
